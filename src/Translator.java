...
public class Translator {
	public ArrayList<String> translate(Parser p, List<IntermediateLang.Instruction> instructions, boolean useDSNotation) {
		switch(p.settings.target) {
		case TI83pz80:
			return translateTI83pz80(instructions, useDSNotation,0,p);
		case z80Emulator:
	...
	private ArrayList<String> translateTI83pz80(List<IntermediateLang.Instruction> instructions, boolean useDSNotation, int stackDepth, Parser p) {
