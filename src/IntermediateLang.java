...
public class IntermediateLang {
	...
	private ArrayList<Parser.Data> typesForIn = new ArrayList<>();
	private ArrayList<Instruction> inops = new ArrayList<Instruction>();
	private String includeInOps(Parser.Data rangeType) {
		//implementing 'in'
		// x ptr
		// x b x a
		...
		if(typesForIn.contains(rangeType))
			return ret;
		typesForIn.add(rangeType);
		switch(rangeType) {
			case Brangecc:
				results.add(InstructionType.general_label.cv("__impl_in_cc_b"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_than_b.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement.cv());//2 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_equal_b.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			case Rangecc:
				/* int version a <= x <= b
				 x!<a
				...
				results.add(InstructionType.general_label.cv("__impl_in_cc_i"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_than_i.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement_intsize.cv());//2 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_equal_i.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			case Brangeoo:
				/* byte version a < x < b
				...
				results.add(InstructionType.general_label.cv("__impl_in_oo_b"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_equal_b.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement.cv());//2 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_than_b.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			case Rangeoo:
				/* int version a < x < b */
				
				results.add(InstructionType.general_label.cv("__impl_in_oo_i"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_equal_i.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement_intsize.cv());//2 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_than_i.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			case Brangeco:
				/* byte version a <= x < b
				...
				results.add(InstructionType.general_label.cv("__impl_in_co_b"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_than_b.cv());//3 stack items   fail if x<a
			...
			case Rangeco:
				...
				results.add(InstructionType.general_label.cv("__impl_in_co_i"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_than_i.cv());//3 stack items   fail if x<a
			...
			case Ubrangecc:
				...
				results.add(InstructionType.general_label.cv("__impl_in_cc_ub"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_than_ub.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement.cv());//2 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_equal_ub.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			case Urangecc:
				/* uint version a <= x <= b
				...
				results.add(InstructionType.general_label.cv("__impl_in_cc_ui"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_than_ui.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement_intsize.cv());//2 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_equal_ui.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			case Ubrangeoo:
				/* ubyte version a < x < b
				...
				results.add(InstructionType.general_label.cv("__impl_in_oo_ub"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_equal_ub.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement.cv());//2 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_than_ub.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			case Urangeoo:
				/* uint version a < x < b */
				
				results.add(InstructionType.general_label.cv("__impl_in_oo_ui"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_equal_ui.cv());//3 stack items   fail if x<a
				results.add(InstructionType.branch_address.cv("__in_failure"));
				results.add(InstructionType.stackincrement_intsize.cv());//2 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_than_ui.cv());//1 stack item
				results.add(InstructionType.exit_routine.cv());
				break;
			...
			case Ubrangeco:
				...
				results.add(InstructionType.general_label.cv("__impl_in_co_ub"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_b.cv());
				results.add(InstructionType.less_than_ub.cv());//3 stack items   fail if x<a
			...
			case Urangeco:
				...
				results.add(InstructionType.general_label.cv("__impl_in_co_ui"));
				results.add(InstructionType.enter_routine.cv("2"));
				results.add(InstructionType.copy2.cv());//4 stack items
				results.add(InstructionType.load_i.cv());
				results.add(InstructionType.less_than_ui.cv());//3 stack items   fail if x<a
		...
		if(inops.isEmpty()) {
			inops.add(InstructionType.general_label.cv("__in_failure"));
			inops.add(InstructionType.notify_stack.cv("2"));
			inops.add(InstructionType.pop_discard.cv());
			inops.add(InstructionType.overwrite_immediate_byte.cv("0"));
			inops.add(InstructionType.exit_routine.cv());
		}
		inops.addAll(0, results);
		return ret;
	}
	BaseTree base;
